...
class UNet2DConditionModel(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin):
    ...
    def forward(
        ...
        if self.encoder_hid_proj is not None:
            encoder_hidden_states = [self.encoder_hid_proj(hidden_states) for hidden_states in encoder_hidden_states]
            
        # 2. pre-process
        sample = self.conv_in(sample)

        # 3. down
        text_embedding_index = 0
        ...
        for downsample_block in self.down_blocks:
            if (
                ...
                sample, res_samples = downsample_block(
                    ...
                    temb=emb,
                    encoder_hidden_states=encoder_hidden_states[text_embedding_index],
        ...
        for i, upsample_block in enumerate(self.up_blocks):
            ...
            if (
                ...
                # print("upsample_block.has_cross_attention:", i)
                if i == 3:
                    text_embedding_index += 1
