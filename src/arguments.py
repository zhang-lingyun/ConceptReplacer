...
def add_base_args(parser):
    ...
    parser.add_argument("--cross_atten", type=str, default="low")
...
def add_train_args(parser):
    ...
    parser.add_argument("--epoch_to_switch", type=int, default=200)
    parser.add_argument("--lr", type=float, default=0.1)
    parser.add_argument("--lr_lora", type=float, default=0.00001)
...
def add_test_args(parser):
    ...
    parser.add_argument("--test_t", nargs="+", type=float, default=[100.9091])
    ...
    parser.add_argument("--avg_time", action="store_true", default=False)
    return parser
